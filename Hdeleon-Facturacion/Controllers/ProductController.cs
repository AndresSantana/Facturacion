    ...
    public class ProductController : BaseCrudController<Models.ViewModels.TableProductViewModel>
    {
        ...
        public ActionResult Edit(int Id)
        {
            ...
            using (Models.SAT.satEntities db= new Models.SAT.satEntities())
            {
                ...
                ViewBag.ClaveProdServ = oClaveProdServ !=null? oClaveProdServ.c_ClaveProdServ + " - "+oClaveProdServ.Descripción :  "";
                ViewBag.ClaveUnidad = oClaveUnidad !=null? oClaveUnidad.c_ClaveUnidad + " - "+oClaveUnidad.Descripción :  "";
